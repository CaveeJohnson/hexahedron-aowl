...
function easylua.CreateEntity(class, callback)
	...
	this:DropToFloor()
	this:PhysWake()
	if this.CPPISetOwner then this:CPPISetOwner(me) end
...
do -- all
	...
	devs = CreateAllFunction(function(v) return v:IsPlayer() and (v:GetUserGroup() == "developers" or v:GetUserGroup() == "owners") end)
